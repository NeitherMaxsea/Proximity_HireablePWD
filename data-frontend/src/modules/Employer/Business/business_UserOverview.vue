<script setup>
// Taglish guide: Ito ang business user overview module para sa business workspace flow.
// Dito naka-render ang summary cards, filters, at user table na pinapasa mula sa main business container.
